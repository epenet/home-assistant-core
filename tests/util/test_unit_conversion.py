"""Test Home Assistant energy utility functions."""
import pytest
...
@pytest.mark.parametrize(
    ...
    [
        (DistanceConverter, LENGTH_KILOMETERS, LENGTH_METERS, 0.001),
        ...
        (TemperatureConverter, TEMP_CELSIUS, TEMP_FAHRENHEIT, pytest.approx(0.555556)),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (5, LENGTH_YARD, pytest.approx(0.004572), LENGTH_KILOMETERS),
        ...
        (5, LENGTH_YARD, pytest.approx(0.002840909), LENGTH_MILES),
        (5, LENGTH_YARD, pytest.approx(15), LENGTH_FEET),
        (5, LENGTH_YARD, pytest.approx(180), LENGTH_INCHES),
        ...
        (5000, LENGTH_FEET, pytest.approx(0.946969), LENGTH_MILES),
        (5000, LENGTH_FEET, pytest.approx(1666.66667), LENGTH_YARD),
        (5000, LENGTH_FEET, pytest.approx(60000), LENGTH_INCHES),
        ...
        (5000, LENGTH_INCHES, pytest.approx(0.07891414), LENGTH_MILES),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (100, TEMP_FAHRENHEIT, pytest.approx(37.7778), TEMP_CELSIUS),
        (100, TEMP_FAHRENHEIT, pytest.approx(310.9278), TEMP_KELVIN),
        (100, TEMP_KELVIN, pytest.approx(-173.15), TEMP_CELSIUS),
        (100, TEMP_KELVIN, pytest.approx(-279.67), TEMP_FAHRENHEIT),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (100, TEMP_FAHRENHEIT, pytest.approx(55.5556), TEMP_CELSIUS),
        (100, TEMP_FAHRENHEIT, pytest.approx(55.5556), TEMP_KELVIN),
